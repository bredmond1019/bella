...
name: log-work
description: >
  Trigger on '/log-work' or when running the Log Work command (Sync status.md and append a Log entry for completed work.)
---
...
7. **Sync the company brain.** After status.md and log.md are confirmed:
   - Read `../docs/projects/bella.md` in the company brain.
...
- `log.md`
- `../docs/projects/bella.md` (brain sync target)
