...
**Last updated:** 2026-06-25 — Block D complete; mouse support (5 tasks), 195 tests pass
...
| Block D | Mouse | Done | scroll/hover/click-to-follow/drag-select (clipboard)/double-click word-select; arboard dep; 195 tests — **= v0.1** |
