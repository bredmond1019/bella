---
type: Index
title: Bella — Planning Docs
description: Navigation index for the Bella planning folder.
---

# Bella — Planning Docs

The strategy, state, and decision record for Bella. Code lives elsewhere; this
folder is the map.
