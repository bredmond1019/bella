...
The file above carries everything that is true for any agent working in this repo: what Bella is,
the orientation pointers, the standing rules, the known bugs, build/test/run, the directory map,
